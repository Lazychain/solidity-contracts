...
contract Lazy721 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Pausable, Ownable, ERC721Burnable {
    ...
    constructor(string memory name, string memory symbol, uint256 tokenCap) ERC721(name, symbol) Ownable(msg.sender) {
        _tokenCap = tokenCap;
    }
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        if (_nextTokenId >= _tokenCap) revert TokenCapExceeded();
